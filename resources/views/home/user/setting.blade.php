    ...
    <div class="main-wrap">
        ...
        <div class="user-info">
            ...
            <div class="user-infoPic">
                ...
                <div class="filePic">
                    <img style="cursor: pointer;width: 60px;height: 60px;" id="avatar_img" class="am-circle am-img-thumbnail" src="" alt="{{ $user->name }}" />
                </div>
            ...
            <div class="info-main">
                ...
                @endif
                <form class="am-form am-form-horizontal" method="post" action="{{ route('user.update') }}">

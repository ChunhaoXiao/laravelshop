				...
				<div class="order-logistics">
					<a href="#">
						...
						<div class="latest-logistics">
							<p class="text">订单号：{{ $order->order_sn }}</p>
							<div class="time-list">
					...
					<div class="order-address">
						...
						<div class="new-mu_l2a new-p-re">
							<p class="new-mu_l2cw">
								...
								<span class="dist">{{ $order->address->district }}</span>区
							...
							<div class="order-left">
                                ...
                                @foreach ($orderproduct as $orderDetail)
                                    <ul class="item-list">
                                        <li class="td td-item">
                                            <div class="item-pic">
                                                <a href="{{ route('product.show',['product'=>$orderDetail->product_id]) }}" class="J_MakePoint">
                                                    <img width="100" height="100" src="{{ asset('storage/'.$orderDetail->product->thumb) }}" class="itempic J_ItemImg">
                                                </a>
                                            </div>
                                            <div class="item-info">
                                                <div class="item-basic-info">
                                                    <a href="{{route('product.show',['product'=>$orderDetail->product_id])  }}">
                                                        <p>{!! $orderDetail->product->brief !!}</p>
                                                    </a>
                                                </div>
                                            </div>
                                        </li>
                                        ...
                                        <li class="td td-number">
                                            <div class="item-number">
                                                <span>×</span>{{ $orderDetail->product_number }}
                                            </div>
                                        </li>
